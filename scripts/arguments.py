...
def parse_arguments():
    ...
    parser.add_argument('--epochs', '-e', type=int, default=50, help="total epochs to run")
    ...
    parser.add_argument('--annotation-size', '-as', type=int, default=4, help="size of annotations")
